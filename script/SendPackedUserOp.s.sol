...
contract SendPackedUserOp is Script {
    ...
    function generateSignedUserOperation(
        ...
        uint256[] memory private_keys =new uint256[](3);
        // Assign values to the array inside the constructor
        private_keys[0]=0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80;
        private_keys[1]=0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d;
        private_keys[2]=0x5de4111afa1a4b94908f83103eb1f1706367c2e68ca870fc3fb9a804cdab365a;
        ...
        for(uint256 i=0; i<private_keys.length; i++)
        {
            ...
            if (block.chainid == 31337) {
                (v, r, s) = vm.sign(private_keys[i], digest);
            } else {
                (v, r, s) = vm.sign(config.account, digest);
            }

            // Concatenate the signature (r, s, v)
            signatures = abi.encodePacked(signatures, r, s, v); // Append each signature

        }

        userOp.signature =signatures; // Note the order
        return userOp;
    }
